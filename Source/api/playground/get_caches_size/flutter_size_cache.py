...
def get_flutter_size():
    system = platform.system()

    if system == "Windows":
        windows_cache_flutter_path = os.path.join(os.environ.get('LOCALAPPDATA', ''), 'Pub', 'Cache')
        ...
        macos_cache_flutter_path = os.path.expanduser('~/.pub-cache')
